...
<p> To test this application, XUnit framework is used. Following two packages need to install to test this application:<p>
 <p> xunit </p> 
 <p> xunit.runner.visualstudio </p>
 <p> Command to run test cases: dotnet test
